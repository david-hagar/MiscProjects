 ...
 * @since 1.5
 */
public class UpdatablePriorityQueue<E extends IndexStorage> extends AbstractQueue<E> {
     ...
     * @since 1.8
     */
    public UpdatablePriorityQueue(Comparator<? super E> comparator) {
    ...
    public UpdatablePriorityQueue(Collection<? extends E> c) {
     ...
     */
    @SuppressWarnings("unchecked")
    public UpdatablePriorityQueue(java.util.PriorityQueue<? extends E> c) {
     ...
     */
    @SuppressWarnings("unchecked")
    public UpdatablePriorityQueue(SortedSet<? extends E> c) {
        this.comparator = (Comparator<? super E>) c.comparator();
